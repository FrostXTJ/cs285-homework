...
class FFModel(nn.Module, BaseModel):
    ...
    def get_prediction(self, obs, acs, data_statistics):
        ...
        prediction, _ = self(
            ...
            data_statistics['delta_std']) # DONE get the predicted next-states (s_t+1) as a numpy array
    ...
    def update(self, observations, actions, next_observations, data_statistics):
        ...
        :return:
        """
        # DONE compute the normalized target for the model.
        delta_target_normalized = ptu.from_numpy(normalize(next_observations - observations, data_statistics['delta_mean'], data_statistics['delta_std'])) 
        ...
        loss = self.loss(delta_pred_normalized, delta_target_normalized)  # DONE compute the loss
        # Hint: `self(...)` returns a tuple, but you only need to use one of the
        # outputs.
